...
app.post("/login", function (request, response) {
    ...
    // check if username exists, then check passwd enterdd matched passweord stored
    ...
    } else { response.redirect(`./login?err=${login_username} does not exist!`);
    }
